...
Route.patch('/groups/:groupId', 'GroupsController.update').middleware('auth')
Route.delete('/groups/:groupId', 'GroupsController.destroy').middleware('auth')
Route.delete('/groups/:groupId/players/:playerId', 'GroupsController.removePlayer').middleware(
  'auth'
)
//GroupRequests Routes
